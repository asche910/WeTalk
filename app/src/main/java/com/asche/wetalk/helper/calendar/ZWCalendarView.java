package com.asche.wetalk.helper.calendar;
...
public class ZWCalendarView extends FrameLayout {
    ...
    private void init(AttributeSet attrs, int def) {
        ...
        config.isShowOtherMonth = array.getBoolean(R.styleable.ZWCalendarView_isShowOtherMonth, true);
        ...
        config.isShowLunar = array.getBoolean(R.styleable.ZWCalendarView_isShowLunar, true);
        ...
        config.limitFutureMonth = array.getBoolean(R.styleable.ZWCalendarView_limitFutureMonth, true);
        array.recycle();
        initPager();
    }
